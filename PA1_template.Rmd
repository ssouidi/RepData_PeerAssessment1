...
```
Make data Frame to do calculation
...
Create a new factor variable in the dataset with two levels weekda  and weekend indicating whether a given date is a weekday or weekend day.
```{r}
